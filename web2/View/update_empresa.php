    ...
    <div style="display:flex;justify-content:center;align-items:center;">
        <form method="post">
            <div class="form-group">
                <label for="exampleInputEmail1" style="display:flex;justify-content:center;align-items:center;">Nome</label>
                <input type="textl" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nome">
                <label for="exampleInputEmail1" style="display:flex;justify-content:center;align-items:center;">Tipo de Atendimento</label>
                <input type="textl" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="tipofd">
                <small id="emailHelp" class="form-text text-muted">Formato a qual a Empresa atende. Fisico ou Digital.</small>
            </div>
            <div style="display:flex;justify-content:center;align-items:center;">
...
<?php
    require_once dirname(__FILE__)."./../Controller/update_empresa_controller.php";
?>
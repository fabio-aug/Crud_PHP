    ...
    <div style="display:flex;justify-content:center;align-items:center;">
        <form method="post">
            <div class="form-group">
                ...
                <label for="exampleInputEmail1" style="display:flex;justify-content:center;align-items:center;">Cpf</label>
...
<?php
    require_once dirname(__FILE__)."./../Controller/create_pessoa_controller.php";
?>